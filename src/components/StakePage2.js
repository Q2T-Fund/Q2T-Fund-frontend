                ...
                <div className="stake-form-container">
                    <div>
                        ...
                        <div className="form-subsection currency">
                            ...
                            <p ><>Stablecoins are non-volatile cryptocurrencies. They are “pegged” to Fiat (USD), so to remain stable:<br />1 DAI  = 1 US Dollar<br />1 USDC = 1 US Dollar</></p>
                        </div>
                        ...
                        <div className="form-subsection amount">
                            ...
                            <Input
                                ...
                                className="input2"
                            /> 
                            <p>The amount of tokens you stake for your community.</p>
                        </div>
                    </div>
